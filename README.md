...
```bash
sudo nano /etc/systemd/system/license-tracker.service
```

### Option 3: tmux (Development)
```bash
tmux new-session -d -s license-tracker
tmux send-keys -t license-tracker "streamlit run app.py --server.port 8501 --server.address 0.0.0.0" Enter
```

## 💰 Cost Considerations

Monitor your AWS usage for:
- EC2 instance hours
...
**Created by Akash Danda**

- Email: akashdanda06@gmail.com
- GitHub: [@yourusername](https://github.com/yourusername)
- Project Link: [https://github.com/yourusername/license-tracker](https://github.com/yourusername/license-tracker)
